from micro.func.context import Context
from micro.utils.json_utils import dumps as json_encode
...
class WebSocketRpcHandler(tornado.websocket.WebSocketHandler):
    ...
    def on_message(self, message):
        ...
        context = Context(self._client_id, id_, action, self._cookies_)
        try:
    ...
    def write_result(self, service, context, result):
        ...
        if isinstance(result, tuple) and isinstance(result[0],Context):
